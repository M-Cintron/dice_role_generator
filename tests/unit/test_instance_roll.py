...
def roll_1000(*args, advantage=None, show_advantage_val=False):
    """
    Use roll() 1000 times with the given inputs and return a dictionary, with the keys
    being the numbers that were rolled and the associated values being how many times a given
    number was rolled
    """
    vals = {}
    roller_instance = dice_roller.DiceRoller()
    for _ in range(1000):
        result = roller_instance.roll(*args, advantage=advantage,
